  ...
  "accounts": [
    {
      ...
      "saved_at": "2026-06-08T12:40:35.717143+00:00"
          ...
          <p class="import-note">
            ...
            • provider: claude | openai | gemini | antigravity | deepseek | xiaomi | zhipu | qwen | kimi | minimax | sub2api<br>
            • name: 账号名称（必填）<br>
            • accessToken: 访问令牌（必填）<br>
            • refreshToken: 刷新令牌（可选）<br>
            • baseUrl: Sub2API 部署地址（provider=sub2api 时必填）；Antigravity 专用地址可带 /antigravity<br>
