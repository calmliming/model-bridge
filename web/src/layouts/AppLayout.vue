...
const menuIconPaths = {
  ...
  'api-docs': [
    'M17.25 6.75 19.5 9l-2.25 2.25M6.75 17.25 4.5 15l2.25-2.25M9.75 19.5h4.5A2.25 2.25 0 0016.5 17.25V6.75A2.25 2.25 0 0014.25 4.5h-4.5A2.25 2.25 0 007.5 6.75v10.5A2.25 2.25 0 009.75 19.5z',
  ],
  settings: [
