...
/**
 * Converts an OpenAI Chat Completions SSE stream (what Xiaomi MiMo sends back
...
// field verbatim. We read it back in converter.ts so MiMo's reasoner gets
// `reasoning_content` on every echoed assistant turn (otherwise MiMo rejects
...
export function createXiaomiResponsesStreamTransform(): StreamTransform {
